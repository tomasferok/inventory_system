defmodule InventorySystem.InventoriesTest do
  use InventorySystem.DataCase

  alias InventorySystem.Inventories

  describe "inventories" do
    alias InventorySystem.Inventories.Inventory

    import InventorySystem.InventoriesFixtures
